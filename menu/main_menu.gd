...
func _ready():
	#$ButtonContainer/Button.pressed.connect(func(): _load_level("res://levels/Level1.tscn"))
	...
	$ButtonContainer4/Button4.pressed.connect(func(): _load_level("res://levels/Level4.tres.tscn"))
